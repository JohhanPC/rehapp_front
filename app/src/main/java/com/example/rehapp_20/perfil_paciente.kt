...
class perfil_paciente : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        user?.let {
            ...
            findViewById<EditText>(R.id.edit_text_nombre_paciente).setText(it.userName)
            findViewById<EditText>(R.id.edit_text_identificacion_paciente).setText(it.identificationNumber)
            findViewById<EditText>(R.id.edit_text_ubicacion_paciente).setText(it.city)
            findViewById<EditText>(R.id.edit_text_contacto_paciente).setText(it.phoneNumber)
            findViewById<EditText>(R.id.edit_text_Correo_paciente).setText(it.email)
            findViewById<EditText>(R.id.edit_text_edad_paciente).setText(it.age.toString())
        }
