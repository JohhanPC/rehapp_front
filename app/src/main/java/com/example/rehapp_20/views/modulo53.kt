...
class modulo53: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_modulo33)
        ...
        txt1.setOnClickListener {
            ...
            val intent: Intent = Intent(this,  final_modulo5 :: class.java)
            startActivity(intent)
        ...
        txt2.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo52 :: class.java)
            startActivity(intent)
