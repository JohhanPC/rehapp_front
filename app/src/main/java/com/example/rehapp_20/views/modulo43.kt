...
class modulo43: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_modulo43)
        ...
        txt1.setOnClickListener {
            ...
            val intent: Intent = Intent(this, final_modulo4:: class.java)
            startActivity(intent)
        ...
        txt2.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo42 :: class.java)
            startActivity(intent)
