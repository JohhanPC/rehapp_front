...
class modulo42: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_modulo42)
        ...
        txt1.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo43:: class.java)
            startActivity(intent)
        ...
        txt2.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo41 :: class.java)
            startActivity(intent)
