...
class modulo22: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_modulo22)
        ...
        txt1.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo23:: class.java)
            startActivity(intent)
        ...
        txt2.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo21 :: class.java)
            startActivity(intent)
