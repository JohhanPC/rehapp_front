...
class modulo52: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_modulo52)
        ...
        txt1.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo53:: class.java)
            startActivity(intent)
        ...
        txt2.setOnClickListener {
            ...
            val intent: Intent = Intent(this, modulo51 :: class.java)
            startActivity(intent)
